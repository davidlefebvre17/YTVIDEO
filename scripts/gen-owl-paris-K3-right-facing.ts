...
const OUT = path.join(ROOT, "data", "owl-paris-K3-right-facing.png");

const EDIT_PROMPT = `Only move the owl himself: he is no longer sitting in the armchair. He is now standing far in the background near the glass wall, on the RIGHT side of the room, facing the camera with his face fully visible, both hands deep in his trouser pockets. The owl appears smaller in the frame because he is further from the camera.
